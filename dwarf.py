...
class Dwarf:
    def __init__(self, master, input_file):
        self.master = master
        self.dwarf = tkinter.Toplevel(master)
        self.input_file = input_file
        self.dwarf.title('Race: Dwarf')
        self.img_frame = tkinter.Frame(self.dwarf)
        self.desc_frame = tkinter.Frame(self.dwarf)
        self.name_frame = tkinter.Frame(self.dwarf)
        self.stat_frame = tkinter.Frame(self.dwarf)
        self.bottom_frame = tkinter.Frame(self.dwarf)
        self.dwarf.grid()

        # Top Image ----------------------------------------------------
        self.canvas = tkinter.Canvas(self.dwarf, width=400, height=125)
        self.pop = tkinter.Canvas(self.dwarf)
        ...
        dwarfimage = tkinter.PhotoImage(file='dwarfimg.png')

        self.canvas2.create_image(200, 75, image=dwarfimage)
        self.canvas2.pack()

        # Description ----------------------------------------------------

        self.desc = tkinter.Label(self.desc_frame, text='(+2 CON/+2 WIS)'
